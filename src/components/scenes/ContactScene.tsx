  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center max-w-7xl w-full px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-10 w-full justify-center items-center md:items-start">
        ...
        {/* Footer */}
        <motion.div 
          className="mt-3 sm:mt-16 md:mt-20 text-bold opacity-60 pb-4"
          initial={{ opacity: 0 }}
